!function (a) {
    "use strict";
    var b = document.getElementById("line-basic").getContext("2d");
    window.myLine = new Chart(b, {
        type: "line",
        data: {
        ...
        options: {
            responsive: !0,
            title: {display: !0, text: "Transaction Summary"},
    ...
    }), a(".sparkbar").sparkline("html", {
        type: "bar",
        height: "100px",
        width: "100%",
        barWidth: 15,
        barSpacing: 2
    }), a(".sparkpie").sparkline("html", {type: "pie", height: "100px"}), a("#world-map").vectorMap({
        map: "world_en",
        color: "#ffffff",
        hoverOpacity: .7,
