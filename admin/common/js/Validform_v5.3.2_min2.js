...
(function (d, f, b) {
    ...
    var e = {
        ...
        w: {
            "*": "Can't be empty!",
            "*6-16": "Please fill in 6 to 16 arbitrary characters!",
            ...
            "m": "Please fill in the cell phone number!",
            "e": "The mailbox address format is not correct!",
            "url": "Please fill in the website!"
        },
        def: "Please fill in the correct information!",
        undef: "Datatype is undefined!",
        reck: "The contents of the two inputs are inconsistent!",
        r: "Pass the information validation!",
        c: "Information is being detected.",
        s: "Please {fill in | select }{0|信息}!",
        v: "The information has not been verified. Please wait a moment.",
        p: "Data is being submitted"
    };
    d.Tipmsg = e;
