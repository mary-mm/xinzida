...
f);F+="</Table>\r";ma.push(F)});m={};for(var D={},h,O,V=0,Z=z.length;V<Z;V++)h=z[V],O=m[h],O=m[h]=null==O?1:O+1,2===O&&(z[D[h]]=z[D[h]].substring(0,29)+"-1"),1<m[h]?z[V]=z[V].substring(0,29)+"-"+m[h]:D[h]=V;m='<?xml version="1.0" encoding="UTF-8"?>\r<?mso-application progid="Excel.Sheet"?>\r<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"\r xmlns:o="urn:schemas-microsoft-com:office:office"\r xmlns:x="urn:schemas-microsoft-com:office:excel"\r xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet"\r xmlns:cn="http://www.w3.org/TR/REC-html40">\r<DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">\r  <Created>'+
...
0<f&&(p+=' colspan="'+f+'"');d=T(d);0<d&&(p+=' rowspan="'+d+'"');"string"===typeof e&&""!==e&&(e=ua(e),e=e.replace(/\n/g,"<br>"));p+=">"+e+"</td>"}});0<p.length&&(F+="<tr>"+p+"</tr>");n++});a.displayTableName&&(F+="<tr><td></td></tr><tr><td></td></tr><tr><td>"+B(c("<p>"+a.tableName+"</p>"))+"</td></tr>");F+="</tbody></table>"});h='<cn xmlns:o="urn:schemas-microsoft-com:office:office" '+h+' xmlns="http://www.w3.org/TR/REC-html40">'+('<meta http-equiv="content-type" content="application/vnd.ms-'+
...
h+="br {mso-data-placement:same-cell;}";h+="</style>";h+="</head>";h+="<body>";h+='<div class="Section'+("landscape"===a.mso.pageOrientation?"2":"1")+'">';h+=F;h+="</div>";h+="</body>";h+="</cn>";if("string"===a.outputMode)return h;if("base64"===a.outputMode)return H(h);J(h,a.fileName+"."+D,"application/vnd.ms-"+m,"","base64",!1)}else if("png"===a.type)html2canvas(c(w)[0]).then(function(b){b=b.toDataURL();for(var c=atob(b.substring(22)),e=new ArrayBuffer(c.length),f=new Uint8Array(e),g=0;g<c.length;g++)f[g]=
