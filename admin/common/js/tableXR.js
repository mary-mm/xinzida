    ...
    _createClass(Table, [{
        ...
        key: 'showPage', value: function showPage(data_) {
            ...
            if (data.length > num) {
                ...
                var pageArr = ['<ul class="' + (pages > 7 ? 'ellipsis' : '') + '">', '<li><a class="prev not_allow">涓婁竴椤�</a></li>'].concat(_toConsumableArray(li_List), ['<li><a class="next">涓嬩竴椤�</a></li>', '</ul>']);
